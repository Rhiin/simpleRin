                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['tag gw? auto blank!!','tag gw? auto blank!!']
                ...
                try:
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'tag gw? auto blank!!':
                                client.sendMessage(receiver, None, contentMetadata={'mid': "LineClient','"}, contentType=13)
